descricoes = {
    ...
    "Go": "Go é uma linguagem de programação de código aberto simples, confiável e eficiente, sendo uma excelente escolha para o desenvolvimento de aplicações de alta performance.",
    ...
    "Git": "Git é um sistema de controle de versões distribuído, utilizado para o versionamento de código, o que a torna essencial para um processo de desenvolvimento organizado.",
